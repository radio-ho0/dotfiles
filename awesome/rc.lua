...
globalkeys = awful.util.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.util.spawn(myterminal) end),
    awful.key({ modkey,           }, "F1",     function () awful.util.spawn(lock_screen) end),
    awful.key({ modkey,           }, "F2",     function () awful.util.spawn(browser)    end),
    awful.key({ modkey,           }, "F3",     function () awful.util.spawn(editor)     end),
    awful.key({ modkey,           }, "F4",     function () awful.util.spawn(easy_editor)     end),
